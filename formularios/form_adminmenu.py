...
from formularios.form_admin_user import AdminFormulario  
from formularios.form_admin_empresa import AdminFormularioEmpresa  
...
class MenuAdmin(QMainWindow):
    def __init__(self):
        ...
        self.admin_formulario_usuarios = AdminFormulario()
        ...
        self.admin_formulario_empresas = AdminFormularioEmpresa()
